...
class WalletServiceTest {
    ...
    void addCategory_empty_shouldThrow() {
        IllegalArgumentException ex = assertThrows(
                ...
                () -> walletService.addCategory(ivan, "   ")
        );
    ...
    void setBudget_forMissingCategory_shouldThrow() {
        IllegalArgumentException ex = assertThrows(
                IllegalArgumentException.class,
                () -> walletService.setBudget(ivan, "Food", 1000)
        );
    ...
    void addIncome_shouldAddTransaction_andNoWarningsInitially() {
        ...
        List<String> warnings = walletService.addIncome(
                ivan, "Salary", 20000, LocalDate.of(2025, 12, 1), "payday"
        );
    ...
    void expenseOverBudget_shouldReturnWarning() {
        ...
        List<String> warnings = walletService.addExpense(
                ivan, "Food", 150, LocalDate.of(2025, 12, 2), "groceries"
        );
    ...
    void expensesGreaterThanIncome_shouldReturnWarning() {
        ...
        List<String> warnings = walletService.addExpense(ivan, "Food", 150, LocalDate.of(2025, 12, 2), null);

        assertTrue(warnings.stream().anyMatch(s -> s.toLowerCase().contains("расходы превысили доходы")));
    }
    ...
    void budgetWarning_shouldBeComputedPerCategory() {
        ...
        List<String> warnings = walletService.addExpense(ivan, "Taxi", 150, LocalDate.of(2025, 12, 2), null);

...
class StatsServiceTest {
  ...
  void setUp() {
    ...
    wallet.addTransaction(
        tx(TransactionType.EXPENSE, "Развлечения", 3000, LocalDate.of(2025, 12, 3)));
    wallet.addTransaction(
        tx(TransactionType.EXPENSE, "Коммунальные услуги", 3000, LocalDate.of(2025, 12, 4)));
    ...
    wallet.addTransaction(
        tx(TransactionType.INCOME, "Зарплата", 40000, LocalDate.of(2025, 12, 15)));
  ...
  void periodFiltering_shouldExcludeTransactionsOutsideRange() {
    ...
    double decExpense =
        stats.totalExpense(wallet, LocalDate.of(2025, 12, 1), LocalDate.of(2025, 12, 31));
  ...
  private static Transaction tx(
      TransactionType type, String category, double amount, LocalDate date) {
